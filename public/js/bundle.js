...
var allbranchForm = document.querySelector('.form__branch--all');
...
if (allbranchForm) allbranchForm.addEventListener('submit', function (e) {
  e.preventDefault();
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "5430" + '/');
